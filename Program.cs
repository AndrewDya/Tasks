...
// array3D [0, 0, 0] = new Random().Next(10, 20);
// array3D [0, 0, 1] = new Random().Next(20, 30);
// array3D [0, 1, 0] = new Random().Next(30, 40);
// array3D [0, 1, 1] = new Random().Next(40, 50);
// array3D [1, 0, 0] = new Random().Next(50, 60);
// array3D [1, 0, 1] = new Random().Next(60, 70);
// array3D [1, 1, 0] = new Random().Next(70, 80);
// array3D [1, 1, 1] = new Random().Next(80, 100);
